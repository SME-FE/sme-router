...
var _cacheBody2 = __webpack_require__(17);
...
var _summer = __webpack_require__(21);

var _autumn = __webpack_require__(26);

var _autumn2 = _interopRequireDefault(_autumn);

var _winter = __webpack_require__(49);
...
menuBar.addEventListener('click', function () {
  var temp = menuList.style.display;
...
var _routeMatcher = __webpack_require__(13);

var _routeMatcher2 = _interopRequireDefault(_routeMatcher);

var _Html5History = __webpack_require__(16);

var _Html5History2 = _interopRequireDefault(_Html5History);

var _HashHistory = __webpack_require__(19);
...
var _queryParser = __webpack_require__(15);
...
var _History2 = __webpack_require__(4);
...
var _morn = __webpack_require__(24);

var _morn2 = _interopRequireDefault(_morn);

var _nightfall = __webpack_require__(25);
...
function summer(req, res, next) {
  ...
  var activeNames = /morn|nightfall/i.exec(location.href);
  if (activeNames) {
    var activePart = document.getElementById(activeNames[0]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./summer.scss", function() {
			var newContent = require("!!../../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./summer.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _autumn = __webpack_require__(27);

var _autumn2 = _interopRequireDefault(_autumn);

var _autumn3 = __webpack_require__(30);

var _autumn4 = _interopRequireDefault(_autumn3);

var _autumn5 = __webpack_require__(48);

var _autumn6 = _interopRequireDefault(_autumn5);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function autumn(req, res, next) {
  var templateType = req.query.type;
  ...
  if (templateType === 'hbs') {
    ...
    res.render(_autumn6.default);
  } else {
    res.render((0, _autumn2.default)(req));
  }
}
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (JSON, body, params, query) {pug_html = pug_html + "\u003Cdiv class=\"content-container\"\u003E\u003Ch2 class=\"content-header\"\u003E秋\u003C\u002Fh2\u003E\u003Cdiv class=\"sub-title\"\u003E\u003Cdiv class=\"route\"\u003E\u002Fautumn\u002F:year\u003C\u002Fdiv\u003E\u003Cdiv class=\"desc\"\u003E 这个页面使用\u003Ccode\u003Epug\u003C\u002Fcode\u003E构建 🐶\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Csection\u003E\u003Cdiv\u003E============================\u003C\u002Fdiv\u003E\u003Cdiv\u003Eparams: " + (pug.escape(null == (pug_interp = JSON.stringify(params)) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv\u003Equery: " + (pug.escape(null == (pug_interp = JSON.stringify(query)) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv\u003Ebody: " + (pug.escape(null == (pug_interp = JSON.stringify(body)) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv\u003E============================\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E\u003Csection class=\"example-box\"\u003E\u003Cdiv class=\"example-head\"\u003E| # example\u003C\u002Fdiv\u003E\u003Cdiv\u003ECurrent Day: \u003Ccode\u003E" + (pug.escape(null == (pug_interp = body.parsedByMiddleware) ? "" : pug_interp)) + "\u003C\u002Fcode\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"mes\"\u003E";
if (body.mes) {
pug_html = pug_html + (pug.escape(null == (pug_interp = body.mes) ? "" : pug_interp));
}
else {
pug_html = pug_html + "Default Mes: I am hwen 😀";
}
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E\u003C\u002Fdiv\u003E";}.call(this,"JSON" in locals_for_with?locals_for_with.JSON:typeof JSON!=="undefined"?JSON:undefined,"body" in locals_for_with?locals_for_with.body:typeof body!=="undefined"?body:undefined,"params" in locals_for_with?locals_for_with.params:typeof params!=="undefined"?params:undefined,"query" in locals_for_with?locals_for_with.query:typeof query!=="undefined"?query:undefined));;return pug_html;};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.body : depth0)) != null ? stack1.mes : stack1), depth0))
    + "\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "        Default Mes: I am hwen 😀\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "<div class=\"content-container\">\n  <h2 class=\"content-header\">秋</h2>\n  <div class=\"sub-title\">\n    <div class=\"route\">/autumn/:year</div>\n    <div class=\"desc\">这个页面使用 <code>handlebars</code> 构建 👨</div>\n  </div>\n  <section>\n    <div>============================</div>\n    <div>params: "
    + alias4(((helper = (helper = helpers.paramsStr || (depth0 != null ? depth0.paramsStr : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"paramsStr","hash":{},"data":data}) : helper)))
    + "</div>\n    <div>query: "
    + alias4(((helper = (helper = helpers.queryStr || (depth0 != null ? depth0.queryStr : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"queryStr","hash":{},"data":data}) : helper)))
    + "</div>\n    <div>body: "
    + alias4(((helper = (helper = helpers.bodyStr || (depth0 != null ? depth0.bodyStr : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"bodyStr","hash":{},"data":data}) : helper)))
    + "</div>\n    <div>============================</div>\n  </section>\n  <section class='example-box'>\n    <div class='example-head'># example</div>\n    <div>Current Day: <code>"
    + alias4(container.lambda(((stack1 = (depth0 != null ? depth0.body : depth0)) != null ? stack1.parsedByMiddleware : stack1), depth0))
    + "</code></div>\n    <div class='mes'>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.body : depth0)) != null ? stack1.mes : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "    </div>\n  </section>\n</div>\n";
},"useData":true});
...
module.exports = "<div class=\"content-container\">\n  <h2 class=\"content-header\">秋</h2>\n  <div class=\"sub-title\">\n    <div class=\"route\">/autumn/:year</div>\n    <div class=\"desc\">这个页面使用 <code>html</code> 构建 🙊</div>\n  </div>\n  <section>\n    <div>============================</div>\n    <div>params: ${params}</div>\n    <div>query: ${query}</div>\n    <div>body: ${body}</div>\n    <div>============================</div>\n  </section>\n  <section class='example-box'>\n    <div class='example-head'># example</div>\n    <div>Current Day: <code>${body.parsedByMiddleware}</code></div>\n    <div class='mes'>\n        Default Mes: I am hwen 😀\n    </div>\n  </section>\n</div>\n";
